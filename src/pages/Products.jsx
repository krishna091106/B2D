...
import { ProductGridSkeleton, FilterSidebarSkeleton } from "../components/SkeletonLoaders";
...
export default function Products() {
  ...
  const filteredProducts = allProducts.filter((p) => {
    ...
    // Get sold status for both products
    ...
    const getIsSold = (product) => {
      ...
      return isSoldInJson || isSoldInAdmin;
    };
    
    const aIsSold = getIsSold(a);
    const bIsSold = getIsSold(b);
    
    // Unsold items first (false < true), sold items at bottom
